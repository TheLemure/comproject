function displayImage(imageSrc) {
  ...
  function displayImageWithText(imageSrc, text, newText) {
    ...
    // Check if the image source is 'assets/shelby-hall.jpg'
    if (imageSrc === 'assets/shelby-hall.jpg') {
      // Set the size of the appended image for 'assets/shelby-hall.jpg' (adjust these values as needed)
    ...
    // Update the usemap attribute to the appropriate map based on the image source
    imgElement.useMap = (imageSrc === 'assets/shelby-hall.jpg') ? '#defaultMap' : '';
  }
  
  // Display the "assets/shelby-hall.jpg" image with 'Green Route' text and new text
  displayImageWithText('assets/shelby-hall.jpg', 'Yellow Route', '\nOrange Route');